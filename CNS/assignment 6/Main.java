...
class linkState{
	...
	public static void dijkstra(int[][] arr, int[] cost, int[] prev, int source, int nodes){ 
	// updates the cost and the previous node array for a perticular source
	...
	// returns the next node in the shortest path from the source
	public static int getNext(int[] prev, int j, int source){
		if(prev[j] == source)
			return j;
	...
	public static void main(String []args){
		...
		System.out.println("Enter the router pair & cost to connect them: ");
